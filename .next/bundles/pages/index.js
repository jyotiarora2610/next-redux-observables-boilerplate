...
(function () {
  ...
  reactHotLoader.register(CharacterInfo, 'CharacterInfo', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/components/CharacterInfo.js');
  reactHotLoader.register(_default, 'default', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/components/CharacterInfo.js');
  leaveModule(module);
})();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__operators__ = __webpack_require__("./node_modules/redux-observable/lib/esm/operators.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_operator_switchMap__ = __webpack_require__("./node_modules/rxjs/operator/switchMap.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ActionsObservable__ = __webpack_require__("./node_modules/redux-observable/lib/esm/ActionsObservable.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__EPIC_END__ = __webpack_require__("./node_modules/redux-observable/lib/esm/EPIC_END.js");
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
      ...
      (_context = __WEBPACK_IMPORTED_MODULE_1_rxjs_operator_map__["map"].call(epic$, function (epic) {
        var vault =  false ? store : {
          ...
          dispatch: function dispatch(action) {
            __webpack_require__("./node_modules/redux-observable/lib/esm/utils/console.js").deprecate('calling store.dispatch() directly in your Epics is deprecated and will be removed. Instead, emit actions through the Observable your Epic returns.\n\n  https://goo.gl/WWNYSP');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createEpicMiddleware__ = __webpack_require__("./node_modules/redux-observable/lib/esm/createEpicMiddleware.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ActionsObservable__ = __webpack_require__("./node_modules/redux-observable/lib/esm/ActionsObservable.js");
/* unused harmony reexport ActionsObservable */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__combineEpics__ = __webpack_require__("./node_modules/redux-observable/lib/esm/combineEpics.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__EPIC_END__ = __webpack_require__("./node_modules/redux-observable/lib/esm/EPIC_END.js");
/* unused harmony reexport EPIC_END */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__operators__ = __webpack_require__("./node_modules/redux-observable/lib/esm/operators.js");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_4__operators__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_operator_filter__ = __webpack_require__("./node_modules/rxjs/operator/filter.js");
...
/***/ "./node_modules/universal-rx-request/lib/index.js":
/***/ (function(module, exports, __webpack_require__) {

!function(e,r){ true?module.exports=r(__webpack_require__("./node_modules/rxjs/Observable.js"),__webpack_require__("./node_modules/rxjs/add/observable/of.js"),__webpack_require__("./node_modules/rxjs/add/operator/concat.js"),__webpack_require__("./node_modules/rxjs/add/operator/map.js"),__webpack_require__("./node_modules/rxjs/add/observable/throw.js"),__webpack_require__("./node_modules/rxjs/add/operator/catch.js"),__webpack_require__("./node_modules/rxjs/add/operator/concatMap.js"),__webpack_require__("./node_modules/rxjs/add/operator/do.js"),__webpack_require__("./node_modules/rxjs/add/operator/filter.js"),__webpack_require__("./node_modules/rxjs/add/operator/mergeMap.js"),__webpack_require__("./node_modules/superagent/lib/client.js")):"function"==typeof define&&define.amd?define(["rxjs/Observable","rxjs/add/observable/of","rxjs/add/operator/concat","rxjs/add/operator/map","rxjs/add/observable/throw","rxjs/add/operator/catch","rxjs/add/operator/concatMap","rxjs/add/operator/do","rxjs/add/operator/filter","rxjs/add/operator/mergeMap","superagent"],r):"object"==typeof exports?exports.rxRequest=r(require("rxjs/Observable"),require("rxjs/add/observable/of"),require("rxjs/add/operator/concat"),require("rxjs/add/operator/map"),require("rxjs/add/observable/throw"),require("rxjs/add/operator/catch"),require("rxjs/add/operator/concatMap"),require("rxjs/add/operator/do"),require("rxjs/add/operator/filter"),require("rxjs/add/operator/mergeMap"),require("superagent")):e.rxRequest=r(e["rxjs/Observable"],e["rxjs/add/observable/of"],e["rxjs/add/operator/concat"],e["rxjs/add/operator/map"],e["rxjs/add/observable/throw"],e["rxjs/add/operator/catch"],e["rxjs/add/operator/concatMap"],e["rxjs/add/operator/do"],e["rxjs/add/operator/filter"],e["rxjs/add/operator/mergeMap"],e.superagent)}(this,function(e,r,t,o,a,n,s,u,d,i,p){return function(e){function r(o){if(t[o])return t[o].exports;var a=t[o]={exports:{},id:o,loaded:!1};return e[o].call(a.exports,a,a.exports,r),a.loaded=!0,a.exports}var t={};return r.m=e,r.c=t,r.p="",r(0)}([function(e,r,t){"use strict";function o(e){if(e&&e.__esModule)return e;var r={};if(null!=e)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(r[t]=e[t]);return r.default=e,r}function a(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(r,"__esModule",{value:!0});var n=t(6),s=a(n),u=t(5),d=o(u);r.default=Object.assign(s.default,d,{importRxExtensions:d.default}),e.exports=r.default},function(r,t){r.exports=e},function(e,t){e.exports=r},function(e,r){e.exports=t},function(e,r){e.exports=o},function(e,r,t){"use strict";Object.defineProperty(r,"__esModule",{value:!0}),r.getStatus=r.STATUS=void 0;var o=Object.assign||function(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var o in t)Object.prototype.hasOwnProperty.call(t,o)&&(e[o]=t[o])}return e},a=t(1);t(2),t(4),t(12),t(9),t(10),t(11),t(3),t(8),t(7);var n=function(e){return e&&e.requestStatus===u.SUCCESS},s=function(e){return e&&e.requestStatus===u.ERROR},u=r.STATUS={FETCHING:"fetching",SUCCESS:"success",ERROR:"error"},d=r.getStatus=function(e,r){return e+"_"+r};r.default=function(){a.Observable.prototype.mapToAction=function(e){return a.Observable.of({type:d(e.type,u.FETCHING),requestStatus:u.FETCHING}).concat(this.map(function(r){return{type:d(e.type,u.SUCCESS),requestStatus:u.SUCCESS,data:r}}).catch(function(r){return a.Observable.of(o({type:d(e.type,u.ERROR),requestStatus:u.ERROR},r))}))},a.Observable.prototype.throwErrorOnFailedRequest=function(){return this.mergeMap(function(e){return s(e)?a.Observable.throw(e):a.Observable.of(e)})},a.Observable.prototype.mergeMapOnSucceedRequest=function(e){return this.mergeMap(function(r){return n(r)?e(r):a.Observable.of(r)})},a.Observable.prototype.flatMapOnSucceedRequest=a.Observable.prototype.mergeMapOnSucceedRequest,a.Observable.prototype.concatMapOnSucceedRequest=function(e){return this.concatMap(function(r){return n(r)?e(r):a.Observable.of(r)})},a.Observable.prototype.doOnSucceedRequest=function(e){return this.do(function(r){n(r)&&e(r)})},a.Observable.prototype.filterOnSucceedRequest=function(){return this.filter(function(e){return n(e)})}}},function(e,r,t){"use strict";function o(e){return e&&e.__esModule?e:{default:e}}function a(e){if(Array.isArray(e)){for(var r=0,t=Array(e.length);r<e.length;r++)t[r]=e[r];return t}return Array.from(e)}Object.defineProperty(r,"__esModule",{value:!0});var n=Object.assign||function(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var o in t)Object.prototype.hasOwnProperty.call(t,o)&&(e[o]=t[o])}return e},s=t(13),u=o(s),d=t(1);t(2),t(4),t(3);var i=function(e){return e instanceof Array};r.default=function(e){var r=e.url,t=e.method,o=void 0===t?"get":t,s=e.options,p=void 0===s?{}:s,c=e.query,f=void 0===c?{}:c,l=e.data,x=void 0===l?{}:l,b=p.agent||u.default;return d.Observable.create(function(e){var t,s=b[o](r).query(f).send(x);return p.type&&(s=s.type(p.type)),p.json&&(s=s.serialize()),p.headers&&(s=s.set(p.headers)),p.withCredentials&&(s=s.withCredentials()),p.responseType&&(s=s.responseType(p.responseType)),p.timeout&&(s=s.timeout(p.timeout)),i(p.auth)&&(s=(t=s).auth.apply(t,a(p.auth))),i(p.redirects)&&(s=s.redirects(p.redirects)),i(p.attaches)&&(s=p.attaches.filter(i).reduce(function(e,r){return e.attach.apply(e,a(r))},s)),i(p.fields)&&(s=p.fields.filter(i).reduce(function(e,r){var t;return(t=s).field.apply(t,a(r))},s)),s.end(function(r,t){r&&e.error({error:r,response:t}),(!t||p.only2xx&&!t.ok)&&e.error({error:"not 2xx",response:t}),e.next(n({},t)),e.complete()}),function(){return s&&s.abort()}})},e.exports=r.default},function(e,r){e.exports=a},function(e,r){e.exports=n},function(e,r){e.exports=s},function(e,r){e.exports=u},function(e,r){e.exports=d},function(e,r){e.exports=i},function(e,r){e.exports=p}])});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_observable_of__ = __webpack_require__("./node_modules/rxjs/observable/of.js");
...
var _default = __WEBPACK_IMPORTED_MODULE_3_next_redux_wrapper___default()(__WEBPACK_IMPORTED_MODULE_4__redux__["a" /* default */], null, {
...
(function () {
  ...
  reactHotLoader.register(Counter, 'Counter', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/pages/index.js');
  reactHotLoader.register(_default, 'default', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/pages/index.js');
  leaveModule(module);
})();
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FETCH_CHARACTER; });
...
(function () {
  ...
  reactHotLoader.register(FETCH_CHARACTER, 'FETCH_CHARACTER', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/actionTypes.js');
  reactHotLoader.register(FETCH_CHARACTER_SUCCESS, 'FETCH_CHARACTER_SUCCESS', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/actionTypes.js');
  reactHotLoader.register(FETCH_CHARACTER_FAILURE, 'FETCH_CHARACTER_FAILURE', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/actionTypes.js');
  reactHotLoader.register(START_FETCHING_CHARACTERS, 'START_FETCHING_CHARACTERS', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/actionTypes.js');
  reactHotLoader.register(STOP_FETCHING_CHARACTERS, 'STOP_FETCHING_CHARACTERS', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/actionTypes.js');
  leaveModule(module);
})();
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return startFetchingCharacters; });
...
(function () {
  ...
  reactHotLoader.register(startFetchingCharacters, 'startFetchingCharacters', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/actions.js');
  reactHotLoader.register(stopFetchingCharacters, 'stopFetchingCharacters', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/actions.js');
  reactHotLoader.register(fetchCharacter, 'fetchCharacter', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/actions.js');
  reactHotLoader.register(fetchCharacterSuccess, 'fetchCharacterSuccess', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/actions.js');
  reactHotLoader.register(fetchCharacterFailure, 'fetchCharacterFailure', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/actions.js');
  leaveModule(module);
})();
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* unused harmony export fetchUserEpic */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_observable_interval__ = __webpack_require__("./node_modules/rxjs/observable/interval.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_redux_observable__ = __webpack_require__("./node_modules/redux-observable/lib/esm/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_universal_rx_request__ = __webpack_require__("./node_modules/universal-rx-request/lib/index.js");
...
var fetchUserEpic = function fetchUserEpic(action$, store) {
  return action$.pipe(Object(__WEBPACK_IMPORTED_MODULE_3_redux_observable__["c" /* ofType */])(__WEBPACK_IMPORTED_MODULE_6__actionTypes__["d" /* START_FETCHING_CHARACTERS */]), Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["mergeMap"])(function (action) {
...
var fetchCharacterEpic = function fetchCharacterEpic(action$, store) {
  return action$.pipe(Object(__WEBPACK_IMPORTED_MODULE_3_redux_observable__["c" /* ofType */])(__WEBPACK_IMPORTED_MODULE_6__actionTypes__["a" /* FETCH_CHARACTER */]), Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["mergeMap"])(function (action) {
...
var rootEpic = Object(__WEBPACK_IMPORTED_MODULE_3_redux_observable__["a" /* combineEpics */])(fetchUserEpic, fetchCharacterEpic);
;
...
(function () {
  ...
  reactHotLoader.register(fetchUserEpic, 'fetchUserEpic', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/epics.js');
  reactHotLoader.register(fetchCharacterEpic, 'fetchCharacterEpic', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/epics.js');
  reactHotLoader.register(rootEpic, 'rootEpic', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/epics.js');
  leaveModule(module);
})();
...
function initStore(initialState) {
  var epicMiddleware = Object(__WEBPACK_IMPORTED_MODULE_3_redux_observable__["b" /* createEpicMiddleware */])(__WEBPACK_IMPORTED_MODULE_5__epics__["a" /* rootEpic */]);
  ...
  var reduxMiddleware = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* applyMiddleware */])(__WEBPACK_IMPORTED_MODULE_1_redux_thunk___default.a, epicMiddleware, logger);

  return Object(__WEBPACK_IMPORTED_MODULE_0_redux__["c" /* createStore */])(__WEBPACK_IMPORTED_MODULE_4__reducer__["a" /* default */], initialState, reduxMiddleware);
};
;
...
(function () {
  ...
  reactHotLoader.register(initStore, 'initStore', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/index.js');
  leaveModule(module);
})();
...
(function () {
  ...
  reactHotLoader.register(INITIAL_STATE, 'INITIAL_STATE', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/reducer.js');
  reactHotLoader.register(reducer, 'reducer', '/Users/jyotiarora/Documents/projects/crm/lifcare-blog-content/redux/reducer.js');
  leaveModule(module);
})();
